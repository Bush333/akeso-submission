...
import linecache
root = "datasets/MPIIFaceGaze/MPIIFaceGaze"
sample_root = "datasets/MPIIGaze/MPIIGaze/Evaluation Subset/sample list for eye image"
out_root = "processed_data"
scale = True
MPII_path="datasets/MPIIGaze/MPIIGaze/Data/Original"
